...
public class PostController {
	...
	public List<Post> searchByContentJpa(@RequestParam("query") String query) {
	    List<Post> posts = postService.searchPostByContentJpa(query);
	    return posts;
	}

	@GetMapping("/posts/search/title")
	public List<Post> searchByTitleJpa(@RequestParam("query") String query) {
	    List<Post> posts = postService.searchPostByTitleJpa(query);
	    return posts;
	}
